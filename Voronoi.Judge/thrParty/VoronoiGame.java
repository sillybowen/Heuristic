...
public class VoronoiGame  extends JApplet
{
    ...
    {   
        ...
        JButton salvaButton =  new JButton(new ImageIcon(VoronoiGame.class.getResource("Save24.gif")));
        salvaButton.setBackground(colore);
        
        JButton clearButton =  new JButton(new ImageIcon(VoronoiGame.class.getResource("New24.gif")));
        clearButton.setBackground(colore);
        
        JButton cancelButton = new JButton(new ImageIcon(VoronoiGame.class.getResource("Delete24.gif")));
        cancelButton.setBackground(colore);
        
        JButton testoButton = new JButton(new ImageIcon(VoronoiGame.class.getResource("Ok2.gif")));
      ...
      */
      ...
      class AscoltaImageSaveNet implements ActionListener
      {
       ...
       class AscoltaResize implements ActionListener
       {
           ...
           {
               if(dim_X <= dim_Y)
                 game.setZoom(600 / (double)dim_X);
               else
                 game.setZoom(600 / (double)dim_Y);
      ...
      if(isApplication)
      {
        ...
        */
        ...
        horizontalCombo.addItem(new Integer(400));horizontalCombo.addItem(new Integer(500));horizontalCombo.addItem(new Integer(600));
        ...
        verticalCombo.addItem(new Integer(400));verticalCombo.addItem(new Integer(500));verticalCombo.addItem(new Integer(600));
        ...
        //htmlFrame.setLocation(600, 100);
        htmlFrame.setSize(370, 600);
        ...
        destro.setPreferredSize(new Dimension(82, dim_Y));
    ...
    */
    ...
    private  int dim_X = 600; //Qua esiste un problema!!Se non sono final non si
    private  int dim_Y = 600; //inizializza l'applet. Bisogna dare come parametri!
