...
There are other optional flags, such as time-delays for each client in case you want to see a player disqualify due to time constraints.  To see built-in help for server and client, run:
/scratch/heuristics/nanomunchers/nanomunchers.exe server -help
- or -
/scratch/heuristics/nanomunchers/nanomunchers.exe client -help
